...
{
    public class GetAllStaffsQuery : PaginationQuery, IRequest<Result<PagedResponse<UserResponse>>>
    {

    }

    public class GetAllStaffsHandler : IRequestHandler<GetAllStaffsQuery, Result<PagedResponse<UserResponse>>>
    {
        ...
        public GetAllStaffsHandler(DataContext context, IMapper mapper, IPaginationHelpers paginationHelper = null, UserManager<ApplicationUser> userManager = null, RoleManager<IdentityRole> roleManager = null)
        {
            _context = context;
            _mapper = mapper;
        ...
        public async Task<Result<PagedResponse<UserResponse>>> Handle(GetAllStaffsQuery query, CancellationToken cancellationToken)
        {
            var role = await _roleManager.FindByNameAsync(RoleName.Staff);
